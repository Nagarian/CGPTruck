...
-- --------------------------------------------------
-- Date Created: 01/20/2016 00:46:45
...
GO
IF OBJECT_ID(N'[dbo].[FK_Phones_User]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Phones] DROP CONSTRAINT [FK_Phones_User];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Step_StepType]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Steps] DROP CONSTRAINT [FK_Step_StepType];
GO
...
-- Creating primary key on [User_Id] in table 'Phones'
